...
\section{Análisis y Resultados}
    ...
    \subsection{Zonas: Activa, Saturación y Corte.}
        ...
        \begin{figure}[H]%[!ht]
            ...
            \caption{Gráfica del comportamiento $\beta$ vs $I_B$.}
            \label{fig:beta}
            \end{center}
        \end{figure}
        ...
        \begin{figure}[H]%[!ht]
            ...
            \caption{Gráfica del comportamiento $I_C$ vs $R_1$.}
            \label{fig:IVSR}
            \end{center}
        \end{figure}
        ...
        \begin{figure}[H]%[!ht]
            ...
            \caption{Gráfica del comportamiento $V_{CE}$ vs $R_1$.}
            \label{fig:VVSR}
            \end{center}
        \end{figure}   
...
\section{Evidencias}
    ...
    \begin{figure}[H]%[!ht]
    \begin{center}
    \includegraphics[width=0.45\textwidth]{IMAGENES/EvidenciaEvaluacion.jpeg} 
    \caption{Evidencia de Evaluación.}
    \label{fig:evalacion}
    \end{center}
    \end{figure}

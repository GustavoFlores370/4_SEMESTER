...
Al término de esta práctica se espera que sea evidente el comportamiento de un diodo, tanto en su región de polarización directa como la de la polarización inversa.
...
Existen dos tipos principales de capacitancia en el diodo:

\subsubsection{Capacitancia de transición o de unión}

Se presenta principalmente en polarización inversa. La región de agotamiento actúa como dieléctrico, mientras que las regiones p y n funcionan como placas conductoras. Desde el punto de vista físico, el diodo puede modelarse como un capacitor cuya capacitancia depende del ancho de la región de agotamiento.
...
donde $W$ es el ancho de la región de agotamiento. Como $W$ aumenta con el voltaje inverso $V_R$, la capacitancia disminuye aproximadamente como:
